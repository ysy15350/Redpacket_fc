...
public class CommFunAndroid extends CommFun {
    ...
    public static String getCahePath() {
        ...
        try {
            ...
            Log.d(TAG, "getCahePath() called with: context = [" + context.getClass().getName() + "] ,path=" + path);
    ...
    public static String getFilesPath() {
        ...
        try {
            ...
            //path: /data/user/0/com.ysy15350.myutil/files

            Log.d(TAG, "getFilePath() called with: context = [" + context.getClass().getName() + "] ,path=" + path);
...
//    存储路径：            /data/data/com.ysy15350.myutil/shared_prefs
                // /data/user/0/com.ysy15350.myutil/shared_prefs/sharedPreferences.xml
